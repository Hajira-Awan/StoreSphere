          ...
          {cartItems.length > 0 && (
            <div className="border-t border-[--color-line] p-4 sm:p-6 bg-[--color-surface-hover]">
              ...
              <div className="flex flex-col gap-3">
                <button
                  disabled
                  title="Checkout flow is planned for Week 3"
                  className="w-full py-3 bg-[--color-accent] text-white rounded-md font-medium disabled:opacity-50 disabled:cursor-not-allowed shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[--color-accent]"
                >
                  Checkout (Coming Week 3)
                </button>
                <button
                  onClick={clearCart}
