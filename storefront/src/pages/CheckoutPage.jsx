...
import { CheckCircle2, ChevronLeft, CreditCard, Truck, ShieldCheck, ArrowRight, ShoppingBag, AlertCircle, RefreshCw } from 'lucide-react';
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-4 flex items-center justify-between border-t border-[--color-line]">
                    ...
                    <button
                      ...
                      disabled={currentStep === 'submitting'}
                      className="px-8 py-3.5 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition-colors flex items-center gap-2 shadow-lg disabled:opacity-50"
                    >
